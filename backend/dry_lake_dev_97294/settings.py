"""
Django settings for dry_lake_dev_97294 project.
...
ROOT_URLCONF = 'dry_lake_dev_97294.urls'
...
WSGI_APPLICATION = 'dry_lake_dev_97294.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_lake_dev_97294 API",
    "DESCRIPTION": "API documentation for dry_lake_dev_97294 App",
    "VERSION": "v1",
}
